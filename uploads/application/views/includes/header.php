          ...
          <div class="row">
            <div class="col-xl-auto header-top-left align-self-center text-center text-xl-start">
              <ul class="element contact-info">
                <li class="contact-phone"><i class="fa fa-phone font-icon sm-display-block"></i> Helpline: 9522-122-133
                </li>
            ...
            <div class="col-xl-auto ms-xl-auto header-top-right align-self-center text-center text-xl-end">
              ...
              <div class="element pt-0 pt-lg-10 pb-0">
                <a href="<?= base_url('appoinment')?>" class="btn btn-theme-colored2 btn-sm ajaxload-popup">Book A Mitra</a>
              </div>
            </div>
          </div>
        </div>
              ...
              <div class="row header-nav-col-row">
                <div class="col-sm-auto align-self-center">
                  <a class="menuzord-brand site-brand" href="index-mp-layout1.html">
                    <img class="logo-default logo-1x" src="<?= base_url()?>assets/images/logo-wide.png" alt="Logo">
                    <img class="logo-default logo-2x retina" src="<?= base_url()?>assets/images/logo-wide.png" alt="Logo">
                  </a>
                </div>
                <div class="col-sm-auto ms-auto pr-0 align-self-center">
                  <nav id="top-primary-nav" class="menuzord theme-color2" data-effect="fade" data-animation="none"
                    ...
                    <ul id="main-nav" class="menuzord-menu">
                      ...
                      <!-- <li><a href="#contact">Get App</a></li> -->
                    </ul>
                  </nav>
                </div>
                <div class="col-sm-auto align-self-center nav-side-icon-parent">
                  <ul class="list-inline nav-side-icon-list">
                    ...
                    <li class="hidden-mobile-mode app-btn"><a href="#" id="top-nav-search-btn">Get App</a></li>
